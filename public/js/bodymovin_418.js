(function(root, factory) {
    ...
    function dataFunctionManager() {
        ...
        function r(t, e) {
            ...
            var D, T, M = [];
            for (n = 0; o > n; n += 1) {
                for (w[n].a.sc && (p.strokeColorAnim = !0), w[n].a.sw && (p.strokeWidthAnim = !0), (w[n].a.fc || w[n].a.fh || w[n].a.fs || w[n].a.fb) && (p.fillColorAnim = !0), T = 0, D = w[n].s.b, s = 0; i > s; s += 1) l[s].anIndexes[n] = T, (1 == D && "" != l[s].val || 2 == D && "" != l[s].val && " " != l[s].val || 3 == D && (l[s].n || " " == l[s].val || s == i - 1) || 4 == D && (l[s].n || s == i - 1)) && (1 === w[n].s.rn && M.push(T), T += 1);
...
$(function() {
    var t = {
        f: function() {
            t.d.find(t.g).css(t.s, t.w);
            t.d.find(t.p).css(t.i, t.b);
        },
        g: "g",
        s: "stroke",
        w: "#ffffff",
